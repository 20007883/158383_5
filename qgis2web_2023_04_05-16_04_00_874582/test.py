    ...
    for row in range(len(rows)):
        ...
        feature = {
            ...
            'properties': {
                ...
                'amenity': rows[row][4],
                'name:ar': rows[row][5],
                'school:gender': rows[row][6],
                'operator:type': rows[row][7],
                'not:name': rows[row][8],
                'contact:facebook': rows[row][9],
                'capacity': rows[row][10],
                'natural': rows[row][11],
                'opening_date': rows[row][12],
                'pedagogy': rows[row][13],
                'ref': rows[row][14],
                'description': rows[row][15],
                'building:levels': rows[row][16],
                'addr:hamlet': rows[row][17],
                'email': rows[row][18],
                'name:etymology:wikidata': rows[row][19],
                'name:etymology': rows[row][20],
                'barrier': rows[row][21],
                'landuse': rows[row][22],
                'wheelchair': rows[row][23],
                'owner': rows[row][24],
                'operator': rows[row][25],
                'building:flats': rows[row][26],
                'grades': rows[row][27],
                'campus': rows[row][28],
                'start_date': rows[row][29],
                'name:mk': rows[row][30],
                'ref:linz:address_id': rows[row][31],
                'addr:suburb': rows[row][32],
                'old_name': rows[row][33],
                'name:mi': rows[row][34],
                'building': rows[row][35],
                'religion': rows[row][36],
                'denomination': rows[row][37],
                'wikipedia': rows[row][38],
                'alt_name': rows[row][39],
                'addr:city': rows[row][40],
                'wikidata': rows[row][41],
                'website': rows[row][42],
                'type': rows[row][43],
                'phone': rows[row][44],
                'name': rows[row][45],
                'addr:street': rows[row][46],
                'addr:postcode': rows[row][47],
                'addr:housenumber': rows[row][48],

                'MOE:years': rows[row][49],
                'MOE:id': rows[row][50],
                'MOE:gender': rows[row][51],
                'MOE:authority': rows[row][52]
